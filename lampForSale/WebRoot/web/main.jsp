  ...
  <div id="top">
  						<div id="left">
								...
								<div class="content">
										<div class="1">
											<div class="prod_img">
													<a href="details.html"><img src="images/1.jpg"/></a>
											</div>
											<div class="prod_det_box">
													<div class="box_top"></div>
												<div class="box_center">
													<div class="prod_title">产品描述：</div>
														 <p class="details">你好大发的艰苦奋斗解放军的飞多久的会计法肯德基番窠倒臼飞开电视龙卷风卡积分法的开发就卡的发加快的数据飞快的时飞快的说法叫的开发进口的浮夸风考的飞机肯德基开发的开发开发看.</p>
														 <a href="details.html" class="more">- 更多详情 -</a>
														 <div class="clear"></div>
												</div>
										...
										<div class="1">
											<div class="prod_img">
													<a href="details.html"><img src="images/3.jpg"/></a>
											</div>
											<div class="prod_det_box">
													<div class="box_top"></div>
												<div class="box_center">
  						...
  						<div id="right">
							...
							<div class="right_title">
								<div class="title"><span class="title_icon"><img src="images/bullet3.gif" /></span>Produce  Advertisement</div>
							</div>	
