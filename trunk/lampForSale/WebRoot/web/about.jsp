...
<div id="ccenter">
					<div id="middle">
								...
								<div id="left">
										<div class="title"><span class="title_icon"><img src="images/bullet1.gif" /></span>About Us</div>
										<div class="tishi">
										...
										<div class="about_border">
										  <ol>
										    <li>注册成为我们网站的会员，请详细填写资料。如:姓名,电话,地址,邮箱等（我现在就去<a href="register.html"><em>注册</em></a>）.</li>
										    <li>登陆我们网站查找您需要的产品，查看商品说明，也可以联系我们询问是否有您需要的产品。 </li>
										    <li>在线下单(不登陆/注册本站会员也可在线下订单)。具体操作步骤如下：1.点击“购买”将您需要的产品放入购物车， 2.进入购物车核对商品并填写要货数量， 3.点击“更新购物车”， 4.进入“结算中心”， 5.核对“商品列表”“收货人信息”并选择“配送方式”和“支付方式”， 6.提交订单。 </li>
										    <li>联系客服核对订购商品现货是否齐全以及确认订单。(注：已付款的订单为有效订单，未及时付款订单保留3天，3天后仍未付款自动注销，期间不对订单产品进行保留。）&nbsp;</li>
										    <li>完成付款后联系客服确认发货，默认为次日发货。(根据地区不同,快递3-5天左右到货,物流7-10天到货)。 </li>
									      </ol>
										  <p>有其他问题请<a href="contact.html"><em>联系我们</em></a> </p>	
										</div>															
								</div>
